...
const App = () => {
  ...
  const users = [
    {
     img:'https://media.istockphoto.com/id/1308635869/photo/young-business-woman-stock-photo.jpg?s=2048x2048&w=is&k=20&c=4t3Si5DeUMSRhaB2-6OT9WRKNukU42ERlyaEC-r3dhQ=',
     intro:'',
     color:'blue',
     tag:'Satisfied'
    },
